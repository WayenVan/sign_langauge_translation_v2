...
class Gemma3SLTForContrastiveLearning(LightningModule):
    ...
    def _init_gemma_model(self):
        ...
        # NOTE: only training for Adapters, Thus it should
    ...
    def forward(
        ...
        video_global_tokens = []
        for b in range(B):
            video_global_token_pos = video_mask[b].nonzero(as_tuple=True)[0][-1]
    ...
    def training_step(self, batch, batch_idx):
        ...
        # NOTE: maybe we don't need to use the labels here, since we are doing contrastive learning
        #
        ...
        feats_1 = output_1.video_global_tokens  # [B, D]
        feats_2 = output_2.video_global_tokens  # [B, D]
    ...
    # NOTE: maybe we don't need this, since we are doing contrastive learning
    #
